...
del obj\*.o             > nul 2> nul
del QET_Klemmenplan.exe > nul 2> nul
...
g++.exe -Wall -std=c++17 -O2 -Iinclude -c inc/parts.cpp           -o obj/inc/parts.o
g++.exe -Wall -std=c++17 -O2 -Iinclude -c main.cpp                -o obj/main.o


rem link it all:
g++.exe -o QET_Klemmenplan obj/inc/pugixml/pugixml.o obj/inc/helpers.o obj/inc/parts.o obj/main.o -s
